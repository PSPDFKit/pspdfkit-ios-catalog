...
class InstantExample: Example {
    ...
    func presentNewSession(on viewController: UIViewController) {
        ...
        // to connect to a PSPDFKit Document Engine.
        //
        // For the purpose of this example we are using the PSPDFKit for Web Catalog server.
        // In your app, this should be replaced by the URL of your that is interacting with the PSPDFKit Document Engine.
        // See https://www.nutrient.io/guides/ios/current/pspdfkit-instant/overview/ for more details.
        ...
        progressHUDItem.push(animated: true, on: viewController.view.window) {
            ...
            // It should ideally provide a signed JWT (and the PSPDFKit Document Engine if not already available)
    ...
    private func presentInstantViewController(for instantDocumentInfo: InstantDocumentInfo, on viewController: UIViewController) {
        ...
        instantViewController.title = "PSPDFKit Instant Example"
