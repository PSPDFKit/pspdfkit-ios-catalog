...
class InstantCollaborationOptionsViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        if configuration.allowJoiningExistingSessions {
            ...
            let joinSessionSection = Section(header: "Join an existing session", rows: joinSessionRows, footer: "Enter a document link's from PDF Viewer or Nutrient Catalog on another device, or from a web browser showing web-examples.services.demo.pspdfkit.com.")
