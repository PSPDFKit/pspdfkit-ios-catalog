...
private class SplitContainerViewController: UIViewController, ContainerViewControllerDelegate {
    ...
    override var keyCommands: [UIKeyCommand]? {
        ...
        let toggleSidebarCommand = UIKeyCommand(title: "Toggle Sidebar", action: #selector(togglesSidebar(_:)), input: "L", modifierFlags: [.control, .command], discoverabilityTitle: "Toggle Sidebar")
