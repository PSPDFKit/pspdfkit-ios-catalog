...
private class OfficeDocumentPickerTableViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        return [
            Section(header: "Office file conversion powered by PSPDFKit Document Engine", rows: [], footer: "NOTE: This example needs a local instance of PSPDFKit Document Engine which supports running Office file conversion. Steps to setup the local server can be found at: https://pspdfkit.com/guides/ios/features/office-conversion/. If using a non-local PSPDFKit Document Engine, change the server URL appropriately."),
