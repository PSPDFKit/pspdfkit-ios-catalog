...
class OfficeDocumentConversionExample: Example {
    ...
    override init() {
        ...
        contentDescription = "Shows how to convert an Office file to PDF using PSPDFKit Document Engine."
...
private class OfficeDocumentPickerTableViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        /// a different public/private key pair for PSPDFKit Document Engine, these JWTs will need to be re-generated. Also note that
        ...
        return [
            Section(header: "Office file conversion powered by PSPDFKit Document Engine", rows: [], footer: "NOTE: This example needs a local instance of PSPDFKit Document Engine which supports running Office file conversion. Steps to setup the local server can be found at: https://www.nutrient.io/guides/ios/features/office-conversion/. If using a non-local PSPDFKit Document Engine, change the server URL appropriately."),
    ...
    private func convertAndPresentDocument(withIdentifier identifier: OfficeDocument) {
        /// NOTE: This example needs a local instance of PSPDFKit Document Engine which supports running Office file conversion.
        ///
        /// Steps to setup the local server can be found at: https://www.nutrient.io/guides/ios/features/office-conversion/
        ///
        /// If using a non-local PSPDFKit Document Engine, change the server URL appropriately.
