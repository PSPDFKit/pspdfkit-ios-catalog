...
private final class AnnotationProcessingPDFViewController: PDFViewController {
    ...
    private func embedAnnotations() {
        let embeddedDocumentURL = TemporaryPDFFileURL(prefix: "embedded")
    ...
    private func flattenAnnotations() {
        let flattenedDocumentURL = TemporaryPDFFileURL(prefix: "flattened")
    ...
    private func removeAnnotations() {
        let removedAnnotationsDocumentURL = TemporaryPDFFileURL(prefix: "removedAnnotations")
