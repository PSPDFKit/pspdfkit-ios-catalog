...
class SwiftUISplitScreenExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        ...
        if #unavailable(iOS 16) {
            ...
            let navigationBar = UINavigationBar.appearance(whenContainedInInstancesOf: [UIHostingController<SwiftUISplitScreenExampleView>.self])
...
private struct SwiftUISplitScreenExampleView: View {
    ...
    @PDFView.Scope var leadingViewScope
    @PDFView.Scope var trailingViewScope
