...
private class BoardMeetingExampleViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        let newMeetingSection = Section(header: "Start a new meeting", rows: [Row(identifier: .newGroup, allowsHighlight: true)], footer: "Get a new document link, then collaborate by entering it in PSPDFKit Catalog on another device, or opening the document link in a web browser.")
        ...
        let joinSessionSection = Section(header: "Join a meeting", rows: joinSessionRows, footer: "Scan or enter a document link from PDF Viewer or PSPDFKit Catalog on another device, or from a web browser showing pspdfkit.com/instant/demo or web-examples.services.demo.pspdfkit.com.")
