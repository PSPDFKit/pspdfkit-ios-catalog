...
///
/// - Nutrient Web SDK examples: https://web-examples.services.demo.pspdfkit.com
...
private class BoardMeetingExampleViewController: UITableViewController {
    ...
    private lazy var sections: [Section] = {
        ...
        let joinSessionSection = Section(header: "Join a meeting", rows: joinSessionRows, footer: "Scan or enter a document link from PDF Viewer or Nutrient Catalog on another device, or from a web browser showing web-examples.services.demo.pspdfkit.com.")
