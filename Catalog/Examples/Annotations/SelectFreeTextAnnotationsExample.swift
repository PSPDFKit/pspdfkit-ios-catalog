...
class SelectFreeTextAnnotationsExample: Example {
    ...
    override func invoke(with delegate: ExampleRunnerDelegate) -> UIViewController? {
        ...
        // Xcode 26.2 (shipping with Swift 6.3.2) introduced weak let support. Using weak var results in a warning.
        // Once we fully moved to Xcode 26.2 we can remove this condition.
#if compiler(>=6.3.2)
