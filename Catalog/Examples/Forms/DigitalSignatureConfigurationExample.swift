...
fileprivate struct SignatureSettingsView: View {
    ...
    private var timestampURL: URL? {
        ...
        case .none:
            return nil
        case .pspdfkit:
            return URL(string: "https://tsa.services.demo.pspdfkit.com/")!
        case .freetsa:
...
fileprivate extension PDFSignatureType {
    static var allCases: [Self] = [.CMS, .pades]
...
fileprivate extension PDFSignatureHashAlgorithm {
    static var allCases: [Self] = [.MD5, .SHA160, .SHA224, .SHA256, .SHA384, .SHA512]
