...
extension Example {
    ...
    class func footerForExampleCategory(_ category: Example.Category) -> String {
        switch category {
        case .top:
            return "Taking your first steps with Nutrient."
        case .collaboration:
            return "Examples showing how Nutrient Instant can be used for collaboration."
        case .swiftUI:
            return "Examples illustrating how Nutrient can be used in SwiftUI projects."
        case .multimedia:
        ...
        case .miscellaneous:
            return "Examples showing how to customize Nutrient for various use cases."
        case .textExtraction:
        ...
        case .subclassing:
            return "Various ways to subclass Nutrient."
        case .sharing:
            return "Examples showing how to customize the sharing experience."
        case .componentsExamples:
            return "Examples showing the various Nutrient components."
        case .analyticsClient:
...
extension Example: Comparable {
    nonisolated public static func < (example1: Example, example2: Example) -> Bool {
